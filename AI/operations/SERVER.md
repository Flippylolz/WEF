...
[ADR-020](../decisions/adr/ADR-020-use-nginx-shared-tls-ingress.md) selects Nginx as the target public web server with Certbot/Let's Encrypt auto-renewal. Owner amendment via [D-009](../decisions/deferred/D-009-shared-tls-hostnames-and-forwarding.md): the initial E7-T10 cutover is **WEF-only** on `2fa54e2405.duckdns.org`; AI Forecast remains on port 3000. **Live status (2026-08-20):** `https://2fa54e2405.duckdns.org` serves WEF through `wef-shared-edge`; Caddy `:3100` remains as rollback; Forecast `:3000` unchanged. [E7-T8](../epics/E7-production-delivery/tasks/E7-T8-build-shared-nginx-tls-ingress.md) / [E7-T9](../epics/E7-production-delivery/tasks/E7-T9-implement-reversible-shared-edge-cutover.md) proved inert topology/automation; [E7-T10](../epics/E7-production-delivery/tasks/E7-T10-roll-out-and-verify-shared-tls.md) completed the live cutover.
