...
- Shared Nginx is the live WEF public web server. Its independently managed edge release, Certbot state, and rollback remain separate from ordinary WEF application releases; AI Forecast remains unchanged on port `3000`.
