...
- [ADR-010 — Isolate WEF on the shared NUC](adr/ADR-010-isolate-wef-shared-nuc.md)
...
- [D-001 — Production server and domain](deferred/D-001-production-server-domain.md) — partially resolved; complete before E7-T2.
