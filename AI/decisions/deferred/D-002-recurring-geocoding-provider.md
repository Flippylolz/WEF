...
- Status: deferred. [ADR-021](../adr/ADR-021-use-cached-provider-neutral-geocoding.md) proposes a provider-neutral historical path but is pending owner approval and does not yet resolve this decision.
