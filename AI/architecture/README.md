...
- Docker Compose runs the system on one server. Caddy remains the implemented anonymous-rehearsal edge; [ADR-020](../decisions/adr/ADR-020-use-nginx-shared-tls-ingress.md) selects shared Nginx/Certbot ingress as the public-launch target.
