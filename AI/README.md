...
- Repository governance: GitHub branch protection enforces pull requests, review, strict CI checks, resolved conversations, linear history, and protection from force-pushes or deletion on `main`; the owner-only administrator bypass remains an audited emergency/bootstrap exception.
