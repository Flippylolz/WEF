...
- [E1-T6: Configure Dependabot update pull requests](../epics/E1-repository-developer-foundation/tasks/E1-T6-configure-dependabot-update-pull-requests.md) — `in_progress`
