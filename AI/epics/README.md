...
- [E24 — Automatic ingestion recovery](E24-automatic-ingestion-recovery/README.md) — `ready`; T1/T2 are done with passing production windows; T3 is promoted with plan revision 3 approved, T4 remains proposed; milestone M5.
