...
- [E3 — Database, geocoding, and media pipeline](E3-database-geocoding-media/README.md) — `in_progress`; spike/plan revision 3 approved (PR #46); E3-T1 and E3-T2 done (T2 via PR #53); E3-T3/E3-T4 dependency-eligible, E3-T5 awaits them; milestones M1, M2.
