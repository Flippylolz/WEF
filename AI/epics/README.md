...
- [E7-T10](E7-production-delivery/tasks/E7-T10-roll-out-and-verify-shared-tls.md): task dependency `E7-T9`; deferred gate `D-009` hostname/router resolution; M3; requirements `none`; decisions `ADR-008, ADR-010, ADR-014, ADR-019, ADR-020`.
