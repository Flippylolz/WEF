...
- [E6 — Quality, security, and operations](E6-quality-security-operations/README.md) — `in_progress`; spike revision 2 approved (PR #49), plan revision 2 approved (PR #50) sequencing E6-T4 (`in_progress`); 6 proposed; milestones M3.
...
- [E6-T4](E6-quality-security-operations/tasks/E6-T4-implement-in-house-registration-and-sessions.md): promoted/in_progress revision 1; satisfied dependencies `E1-T2, E3-T1`; satisfied spike/plan revision 2 gates; M3; requirements `P-008`; decisions `ADR-011, ADR-012, ADR-016`.
