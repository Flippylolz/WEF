...
- [E7-T7](E7-production-delivery/tasks/E7-T7-enable-production-registration-and-contact-reveal.md): `in_progress` under plan revision 8 after E7-T10 HTTPS; M3; requirements `P-008`; decisions `ADR-010, ADR-011, ADR-014, ADR-016, ADR-019, ADR-020`.
