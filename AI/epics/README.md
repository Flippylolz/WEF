...
- [E26 — Automatic location validation and repair](E26-automatic-location-validation/README.md) — `selected`; spike revision 1 advanced on owner direction; implementation plan revision 1 approved; 3 promoted tasks; milestone M5.
