...
- [E24 — Automatic ingestion recovery](E24-automatic-ingestion-recovery/README.md) — `in_progress`; T1/T2 are done with passing production windows under approved plan revision 2; T3/T4 remain proposed; milestone M5.
