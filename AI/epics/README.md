...
- [E6-T6](E6-quality-security-operations/tasks/E6-T6-implement-english-i18n-and-restricted-action-ux.md): promoted/`ready` revision 1; satisfied dependencies `E5-T3, E6-T4, E6-T5` and approved plan revision 4; M3; requirements `P-002, P-008`; decisions `ADR-011, ADR-012, ADR-016`.
