...
- [E24 — Automatic ingestion recovery](E24-automatic-ingestion-recovery/README.md) — `in_progress`; T1 is done with a passing production window; T2 is in progress under approved plan revision 1; T3/T4 remain proposed; milestone M5.
- [E25 — Parser quality and automatic recovery](E25-parser-quality-and-automatic-recovery/README.md) — `ready`; spike and implementation plan revision 1 approved; T1 ready, T2–T4 dependency-gated; milestone M5.
