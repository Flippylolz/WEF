...
- [E6-T1](E6-quality-security-operations/tasks/E6-T1-complete-automated-test-pyramid.md): `in_progress` under plan revision 8; task dependencies `E4-T3, E5-T3`; M3; requirements `P-001, P-002, P-003, P-004, P-005, P-006, P-007, P-008`; decisions `ADR-012, ADR-013, ADR-016`.
