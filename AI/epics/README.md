...
- [E8 — Future Telegram live ingestion](E8-telegram-live-ingestion/README.md) — `ready`; spike revision 2 approved (AD-031); plan revision 2 authorizes E8-T1 + E8-T4 `in_progress`; T2/T3/T5 proposed; D-002 resolved; milestones M4.
...
- [E8-T4](E8-telegram-live-ingestion/tasks/E8-T4-revalidate-geocoder-for-recurring-ingestion.md): promoted/`in_progress` revision 1; task dependencies `E3-T3`; D-002 resolved (retain Geoapify); M4; requirements `P-001, P-007`; decisions `ADR-005, ADR-006, ADR-021`.
