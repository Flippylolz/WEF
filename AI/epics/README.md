...
- [E3 — Database, geocoding, and media pipeline](E3-database-geocoding-media/README.md) — `in_progress`; spike revision 3 approved; plan revision 3 approved (PR #46); E3-T1 done; E3-T2 `in_progress` on `feature/E3-T2-idempotent-persistence`; E3-T3–T5 promoted/draft awaiting their gates; milestones M1, M2.
...
- [E3-T2](E3-database-geocoding-media/tasks/E3-T2-implement-idempotent-persistence-and-reprocessing.md): promoted/in_progress revision 2; satisfied dependencies `E2-T2, E3-T1` and approved revision 3 spike/plan gates; M1; requirements `P-002, P-006, P-007`; decisions `ADR-003, ADR-005, ADR-006, ADR-012`.
- [E3-T3](E3-database-geocoding-media/tasks/E3-T3-implement-geocoder-abstraction-and-cache.md): promoted/draft revision 2; task dependencies `E2-T2, E3-T1, E3-T2`; deferred gate D-002 remains for recurring selection; approved spike gate revision 3; implementation gate blocked pending plan revision 3; hosted comparison hard completion gate; M1; requirements `P-001, P-007`; decisions `ADR-005, ADR-012, ADR-021` (ADR-021 remains proposed).
- [E3-T4](E3-database-geocoding-media/tasks/E3-T4-implement-media-storage-and-derivatives.md): promoted/draft revision 2; task dependencies `E2-T3, E3-T1, E3-T2`; deliberately independent of E3-T3; approved spike gate revision 3; implementation gate blocked pending plan revision 3; M2; requirements `P-005, P-007`; decisions `ADR-005, ADR-007, ADR-012`.
- [E3-T5](E3-database-geocoding-media/tasks/E3-T5-import-and-review-the-complete-dataset.md): promoted/draft revision 2; task dependencies `E2-T5, E3-T2, E3-T3, E3-T4` with E2-T5 satisfied; approved spike gate revision 3; implementation gate blocked pending plan revision 3; M2; requirements `P-001, P-002, P-005, P-007`; decisions `ADR-003, ADR-005, ADR-006, ADR-007, ADR-021` (ADR-021 remains proposed).
### E4
