...
- [E8-T2](E8-telegram-live-ingestion/tasks/E8-T2-implement-secure-telethon-session-and-backfill.md): promoted/`in_progress`; restartable Telethon backfill delivered through PR #167 and live media download through PR #243, with production acquisition evidence still B-003; task dependencies `E8-T1, E3-T2, E8-T4`; M4; requirements `P-006, P-007`; decisions `ADR-005, ADR-006, ADR-007`.
