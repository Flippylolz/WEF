...
- [E28 — Reliable delivery of every new channel offer to the map](E28-live-offer-map-delivery/README.md) — `ready`; spike completed and plan revision 1 authorized by owner research-then-fix direction; five tasks cover templates, locations, nearby towns, galleries and delivery acceptance; milestone M5.
