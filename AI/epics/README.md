...
- [E8 — Future Telegram live ingestion](E8-telegram-live-ingestion/README.md) — `ready`; spike revision 2 approved (AD-031); plan revision 2 authorizes E8-T1 `in_progress` + E8-T4 `done`; T2/T3/T5 proposed; D-002 resolved; milestones M4.
