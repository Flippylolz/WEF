...
- [E24 — Automatic ingestion recovery](E24-automatic-ingestion-recovery/README.md) — `in_progress`; T1/T2 are done with passing production windows; T3 is promoted with plan revision 3 approved, T4 remains proposed; milestone M5.
- [E25 — `in_progress`; T1/T2 merged, deployed and accepted; T3/T4 retain provider and historical replay acceptance gates; milestone M5.
- [E26 — Automatic location validation and repair](E26-automatic-location-validation/README.md) — `done`; T1–T4 released; three reported cases retain protected municipal street-level corrections; municipal-first catalog-wide backfill is owner-approved, enabled and verified, with remaining work continuing under existing budgets; milestone M5.
- [E27 — Faster verified releases](E27-faster-verified-releases/README.md) — `deferred` by owner close-for-now request on 2026-09-05; T1/T2 and measurement tooling merged/deployed; [six-run evidence and local cache proofs](E27-faster-verified-releases/EVIDENCE_CLOSEOUT.md) preserved; final T3 acceptance awaits owner reopening and missing cohort/operational evidence; milestone M5.

- [E28 — Reliable delivery of every new channel offer to the map](E28-live-offer-map-delivery/README.md) — `in_progress`; T1 started; spike completed and plan revision 1 authorized by owner research-then-fix direction; five tasks cover templates, locations, nearby towns, galleries and delivery acceptance; milestone M5.
...
T4 revision 2 is implemented through PR #354 and in progress for production acceptance, with completed T1/T2 dependencies and verified
