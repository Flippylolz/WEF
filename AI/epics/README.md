...
- [E3 — Database, geocoding, and media pipeline](E3-database-geocoding-media/README.md) — `in_progress`; historical revision 3 delivered E3-T2/T4 and merged T3 implementation; spike/plan revision 4 await approval for the Geoapify boundary and quota-aware resumable E3-T5; milestones M1, M2.
