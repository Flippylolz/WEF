...
- [E3-T2](E3-database-geocoding-media/tasks/E3-T2-implement-idempotent-persistence-and-reprocessing.md): promoted/draft revision 2; satisfied dependencies `E2-T2, E3-T1`; approved spike gate revision 3; implementation gate blocked pending plan revision 3; M1; requirements `P-002, P-006, P-007`; decisions `ADR-003, ADR-005, ADR-006, ADR-012`.
