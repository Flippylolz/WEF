...
- [E17 — Raw archive replay and filter integrity](E17-raw-archive-replay-and-filter-integrity/README.md) — `selected`; spike/plan revision 1 approved; E17-T1–T6 promoted; completion is gated on the owner supplying a new data backup that is replayed and promoted to production; milestone M5.
