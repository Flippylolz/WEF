...
- [E22-T1](E22-property-type-filter/tasks/E22-T1-property-classification-and-backfill.md): P1 promoted/`ready`; dependency `E17-T2` and spike/implementation gates satisfied; M5; requirements `P-002, P-003, P-007, P-010`; decisions `ADR-005, ADR-006, ADR-012`; canonical offer classification, safe migration, deterministic provenance, and idempotent historical backfill.
- [E22-T2](E22-property-type-filter/tasks/E22-T2-catalog-property-type-contracts.md): P1 promoted/`draft`; dependencies `E4-T4, E22-T1`; approval gates satisfied and dependency gate blocked; M5; requirements `P-001, P-002, P-003, P-010`; decisions `ADR-005, ADR-012, ADR-013`; shared query semantics, facets, public projections, OpenAPI, and query-plan evidence.
- [E22-T3](E22-property-type-filter/tasks/E22-T3-property-type-filter-ui.md): P1 promoted/`draft`; dependencies `E13-T3, E22-T2`; approval gates satisfied and dependency gate blocked; M5; requirements `P-002, P-003, P-004, P-010`; decisions `ADR-002, ADR-004, ADR-012, ADR-013`; facets-driven accessible filter controls, URL state, chips, labels, and browser coverage.
...
- Evidence-backed Apartment/House/Semi-detached classification and a consistent
  URL-backed public filter: approved E22-T1 through E22-T3; E22-T1 is ready.
