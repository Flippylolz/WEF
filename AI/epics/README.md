...
- [E26 — Automatic location validation and repair](E26-automatic-location-validation/README.md) — `done`; all three tasks released, live canary verified and automatic revalidation enabled; exact reported coordinates remain unresolved and safely quarantined; milestone M5.
