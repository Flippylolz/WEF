...
- [E23 — Location display name normalization](E23-location-display-name-normalization/README.md) — `ready`; spike revision 1 owner-approved (Polish-forward Option 2, verified exempt, near-suburb keep); implementation plan revision 1 drafted pending approval; E23-T1/T2 promoted; milestone M5.
