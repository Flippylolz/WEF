...
- [E19-T3](E19-ai-assisted-place-curation/tasks/E19-T3-batch-offer-enrichment-provenance.md): P0 promoted/`in_progress`; task dependency `E19-T1`; M5; requirement `P-009`; decisions `ADR-012, ADR-016, ADR-022`; checkpointed missing-only batch offer autofill, rollback, AI field origins, and parser-replay feedback.
