...
- [E7 — Docker/GitHub production delivery](E7-production-delivery/README.md) — `ready`; 10 tasks (5 done, 1 draft, 3 proposed, 1 deferred); milestone M3.
...
- [E7-T8](E7-production-delivery/tasks/E7-T8-build-shared-nginx-tls-ingress.md): `done` through [PR #69](https://github.com/Flippylolz/WEF/pull/69), satisfied dependency `E7-T4`; inert topology proven with fixtures only (`.test` hostnames, local Pebble ACME); M3; requirements `none`; decisions `ADR-010, ADR-014, ADR-019, ADR-020`.
