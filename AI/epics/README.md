...
- [E19 — AI-assisted owner catalog curation](E19-ai-assisted-place-curation/README.md) — `ready`; spike revision 4 approved under AD-042 and plan revision 1 approved under AD-043; E19-T1–T4 promoted/`draft`; milestone M5.
...
- [E19-T1](E19-ai-assisted-place-curation/tasks/E19-T1-ai-place-review-backend.md): P0 promoted/`draft`; satisfied dependency `E18-T2`; approved spike revision 4 and plan revision 1; M5; requirement `P-009`; decisions `ADR-012, ADR-016, ADR-021, ADR-022`; Groq GPT-OSS adapter, minimized review persistence, contact-masked full-source reader, and guarded generate/apply backend.
