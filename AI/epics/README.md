...
- [E8 — Future Telegram live ingestion](E8-telegram-live-ingestion/README.md) — `ready`; spike revision 2 approved (AD-031); plan revision 3 authorizes E8-T1/T4/T2 (`in_progress`/`done`/`in_progress`); T3/T5 proposed; D-002 resolved; milestones M4.
