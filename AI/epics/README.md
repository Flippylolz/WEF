...
- [E7 — Docker/GitHub production delivery](E7-production-delivery/README.md) — `planning`; spike revision 4 approved, plan revision 4 awaiting approval; 11 tasks (5 done, 1 promoted draft, 1 invalidated/paused, 3 proposed, 1 deferred); milestone M3.
...
- [E7-T6](E7-production-delivery/tasks/E7-T6-transfer-and-import-the-historical-dataset.md): promoted/`draft` revision 3 against approved spike revision 4; transfers the verified E3-T5 database/media snapshot into a non-public production candidate without reprocessing and leaves activation to E7-T11; implementation gate blocked pending plan revision 4 approval and dependency gate blocked pending E3-T5's completion record; task dependencies `E3-T5, E7-T2, E7-T4`; no deferred gate because it makes no geocoder call; M3; requirements `P-001, P-002, P-005, P-007`; decisions `ADR-005, ADR-006, ADR-007, ADR-008, ADR-010, ADR-014, ADR-015, ADR-019`.
