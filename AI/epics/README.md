...
- [E26 — Automatic location validation and repair](E26-automatic-location-validation/README.md) — `in_progress`; T1–T3 released; three reported cases have protected municipal street-level corrections; T4 municipal-first resolution is deployed and canary-verified; wider backfill awaits owner approval; milestone M5.
