...
- [E19 — AI-assisted owner catalog curation](E19-ai-assisted-place-curation/README.md) — `in_progress`; spike revision 4 approved under AD-042 and plan revision 1 approved under AD-043; E19-T1 `in_progress`, E19-T2–T4 promoted/`draft`; milestone M5.
...
- [E19-T2](E19-ai-assisted-place-curation/tasks/E19-T2-ai-place-review-console.md): P0 promoted/`draft`; task dependency `E19-T1`; M5; requirement `P-009`; decisions `ADR-012, ADR-016, ADR-022`; owner-only Review with AI diff/apply console and production controls.
