...
- [E0 — Architecture and dependency spike](E0-architecture-dependency-spike/README.md) — `in_progress`; spike revision 2/plan revision 3 approved, E0-T1 in progress in the ordered stack and E0-T2 draft; milestones M1.
...
E1-T1 and E0-T1 are `in_progress` in ordered stack layers; E0-T2 remains draft until E0-T1 opens its PR. Reviews and CI still gate base-first merge/completion, but they do not pause preparation of approved descendants. E2–E8 remain `draft`. E1-T5 remains `cancelled`, E7-T5 remains `deferred`, and every unpromoted active task is `proposed`.
