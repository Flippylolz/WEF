...
- [E28 — Reliable delivery of every new channel offer to the map](E28-live-offer-map-delivery/README.md) — `done`; T1–T5 deployed, bounded backfills verified, and genuine continuous 24-hour production acceptance passed; milestone M5.
