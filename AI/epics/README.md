...
- [E7-T11](E7-production-delivery/tasks/E7-T11-activate-the-verified-historical-candidate.md): `in_progress` under plan revision 9; ADR-019 public-activation boundary; task dependencies `E7-T6, E7-T7, E7-T10`; M3; requirements `P-001, P-002, P-005, P-007`; decisions `ADR-008, ADR-010, ADR-014, ADR-015, ADR-019, ADR-020`.
### E8
