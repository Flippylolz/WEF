...
- [E6-T3](E6-quality-security-operations/tasks/E6-T3-add-operational-diagnostics.md): `in_progress` under plan revision 7; task dependencies `E3-T2, E4-T4`; M3; requirements `P-007`; decisions `ADR-008, ADR-010, ADR-014, ADR-015`.
