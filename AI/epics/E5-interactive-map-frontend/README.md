...
- E5-T1 through E5-T3 are `done`; E5-T4 is `in_progress` on branch `cursor/feat-e5-t4-responsive-a11y-0c74`; E5-T5 remains blocked on E5-T4/E4-T4.
...
- [E5-T4: Complete responsive list/map accessibility](tasks/E5-T4-complete-responsive-list-map-accessibility.md) — `in_progress`, P1/L, M3; branch `cursor/feat-e5-t4-responsive-a11y-0c74`
