...
- E5-T1 through E5-T3 are `done` (E5-T3 merged via PR #80); E5-T4 and E5-T5 remain promoted/`draft` with E5-T4 ready to start and E5-T5 blocked on E5-T4/E4-T4.
...
- [E5-T4: Complete responsive list/map accessibility](tasks/E5-T4-complete-responsive-list-map-accessibility.md) — `draft`, P1/L, M3; E5-T2 and E5-T3 satisfied — ready to start
