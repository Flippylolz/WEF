...
- E5-T1 and E5-T2 are `done` (E5-T2 merged via PR #43 with post-merge fix PR #47); E5-T3 is `in_progress` on branch `feat/E5-T3-offer-detail-ui`; E5-T4 and E5-T5 remain promoted/`draft` behind E5-T3/E4-T4 dependency gates.
...
- [E5-T3: Build offer detail and media gallery](tasks/E5-T3-build-offer-detail-and-media-gallery.md) — `in_progress`, P0/L, M3; branch `feat/E5-T3-offer-detail-ui`
