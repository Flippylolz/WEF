...
- `COMPOSE_PROJECT_NAME=wef-e26-t1 make test`: final run passed 1,204 backend tests (90.50% combined line/branch coverage) and 169 frontend tests (95.76% lines, 90.14% branches). The three existing backend warnings did not fail the suite.
- `git diff --check`: pass.
