...
dependency_gate:
  ...
  evidence:
    - "E22-T2 done through https://github.com/Flippylolz/WEF/pull/302"
    - "E13-T3 done on main before E22 implementation"
branch:
  required: true
  name: null
  task_id: E22-T3
...
completion:
  ...
  pull_request: https://github.com/Flippylolz/WEF/pull/302
  evidence:
    - "Filter controls, chips, and offer labels in PR #302"
    - "Production map filter smoke in PRODUCTION_EVIDENCE.md"
invalidation:
  invalidated_by: null
  invalidated_at: null
  reason: null
