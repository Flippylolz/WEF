...
- E2-T5 is `in_progress` with a reconciled local [complete-export audit](AUDIT.md);
...
- [E2-T5: Audit the complete export](tasks/E2-T5-audit-the-complete-export.md) — `in_progress`, P0/L, M2
