...
- Task dependencies: [E4-T1](../tasks/E4-T1-implement-map-query-service-and-geojson-endpoint.md), [E4-T2](../tasks/E4-T2-implement-facets-and-location-offer-collection.md), [E4-T3](../tasks/E4-T3-implement-offer-detail.md), [E3-T5](../../E3-database-geocoding-media/tasks/E3-T5-import-and-review-the-complete-dataset.md)
