...
| E6-T6 i18n/restricted UX | E5-T3, E6-T4, E6-T5 | unblocked; sequenced by plan revision 4 |
| E6-T7 owner console | E6-T4, E6-T5 | blocked on E6-T5 (stackable after T4) |
...
- [E6-T6: Implement English i18n and restricted-action UX](tasks/E6-T6-implement-english-i18n-and-restricted-action-ux.md) — promoted/`ready`; dependencies satisfied; plan revision 4.
