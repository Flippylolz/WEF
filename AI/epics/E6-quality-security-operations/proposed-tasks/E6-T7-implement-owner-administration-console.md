...
- Task dependencies: [E6-T4](../tasks/E6-T4-implement-in-house-registration-and-sessions.md), [E6-T5](../tasks/E6-T5-implement-contact-masking-encryption-reveal-and-audit.md)
