...
- The Caddy wording above is legacy-roadmap provenance, not the current public-edge choice. Media remains edge-agnostic and is served read-only through Nginx after E7-T10, with interim Caddy compatibility only while the rehearsal stack exists.
...
- Task dependencies: [E2-T3](../../E2-historical-export-parser-audit/tasks/E2-T3-implement-media-grouping.md), [E3-T1](../tasks/E3-T1-create-schema-and-migrations.md)
