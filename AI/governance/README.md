...
- GitHub branch protection enforces pull requests, strict required checks, resolved conversations, linear history, and protection from force-pushes or deletion on `main` under ADR-023. Approving reviews are not required while the owner is the sole maintainer.
