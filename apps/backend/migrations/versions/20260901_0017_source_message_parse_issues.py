...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_channel_id"],
            ["source_channels.id"],
            name="fk_sm_parse_issues_channel_id_source_channels",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["source_message_id"],
            ["source_messages.id"],
            name="fk_sm_parse_issues_message_id_source_messages",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["source_message_revision_id"],
            ["source_message_revisions.id"],
            name="fk_sm_parse_issues_revision_id_source_message_revisions",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["ingest_run_id"],
            ["ingest_runs.id"],
            name="fk_sm_parse_issues_run_id_ingest_runs",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["offer_id"],
            ["offers.id"],
            name="fk_sm_parse_issues_offer_id_offers",
            ondelete="RESTRICT",
        ),
