...
def _set_point_document(
    ...
    *,
    ...
    return (
        ...
        "flex-direction:column;height:100vh;background:#ffffff;color:#202222}"
        "header{padding:.6rem 1rem;border-bottom:1px solid #ddd;"
        ...
        "background:#dde3e8;cursor:crosshair;touch-action:none}"
        ...
        "#marker{background:#e5484d;border:2px solid #fff;"
        "box-shadow:0 0 4px rgba(0,0,0,.5);z-index:6}"
        "#ghost{background:#3b82f6;border:2px solid #fff;opacity:.7;z-index:5}"
        ...
        ".offer{border:1px solid #e2e2e2;border-radius:6px;"
        "padding:.5rem;margin:.5rem 0;font-size:.85rem;color:#202222}"
        "h3{color:#202222}"
        ".offer blockquote{margin:.4rem 0;border-left:3px solid #ddd;"
